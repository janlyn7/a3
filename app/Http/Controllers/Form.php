...
class Form {
    ...
    */
    ...
    /**
    * Returns boolean if given value contains only numbers (includes floats)
    */
    ...
    /**
    * Returns boolean if given value contains only digits
    */
    ...
    */
    ...
    /**
    * Returns value if the given value is GREATER THAN the given parameter
    */
    ...
    /**
    * Returns value if the given value is LESS THAN the given parameter
    */
